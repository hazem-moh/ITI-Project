...
export class LoginComponent {
 ...
 // authService = inject(AuthService);
  ...
  // Simulated email verification method
  ...
  //     (response: any) => { // Corrected type for the response
  //       console.log('Registration successful:', response);
  //       alert("Registration Success");

  //       this.authService.sendVerificationEmail(this.userRegisterObj.emailId).subscribe(
  //         (emailResponse: any) => { // Corrected type for the response
  //           console.log('Verification email sent:', emailResponse);
  //           alert(`Verification email sent to ${this.userRegisterObj.emailId}`);
  //         },
