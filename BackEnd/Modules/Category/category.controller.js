...
const deleteCategory = async (req, res, next) => {
    ...
    try {
        ...
        res.status(200).json({ message: "Category and associated data deleted successfully", deletedCategory });
    } catch (error) {
...
module.exports={
deleteCategory,getAllCategories,updateCategory,addCategory
}
