...
const deleteBrand = async (req, res, next) => {
    ...
    try {
        ...
        res.status(200).json({ message: "Brand and associated products deleted successfully", deletedBrand });
    } catch (error) {
...
const addBrand = async (req, res, next) => {
    const { name, description, image, Category: categoryId, SubCategory: subCategoryId } = req.body;
...
module.exports={
    deleteBrand, addBrand, updateBrand, getBrand 
}